...
"hi Visual 			term=bold 			cterm=bold gui=bold guifg=Grey guibg=fg guibg=olivedrab cterm=reverse 
hi Visual       term=NONE cterm=NONE ctermfg=White ctermbg=Red
...
hi Constant 		term=underline ctermfg=Brown guifg=DarkBlue guibg=Grey96
